...
// ISO 3166-1 alpha-2 values are kept internal; people choose readable names.
export const countryOptionList: ReadonlyArray<CountryOption> = [
...
const countryNames = new Map(countryOptionList.map(({ value, label }) => [value, label]));
